...
$is_me = ($user_id == get_user_id()) && ($user_name == get_username());
...
if ($user_id > 0) {
    $db = getDB();
    if($user_name != ""){
        $query = "SELECT email, username, created FROM Users where username = :username";    
    }
    else {
...
<div class="container-fluid">
    <a class="btn btn-secondary btn-sm" href="all_associations.php">Back</a>
