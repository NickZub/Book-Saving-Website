...
$query = "SELECT id, bookID, title, author, image, rating FROM `Books` WHERE 1=1";//ORDER BY created DESC LIMIT 25
...
$table = ["data" => $results, "title" => "Public Books", "ignored_columns" => ["id", "bookID"], "edit_url" => get_url("admin/edit_book.php"), "delete_url" => get_url("admin/delete_book.php"), "view_url" => get_url("view_book.php"), "save_url" => get_url("save_book.php")];
?>
