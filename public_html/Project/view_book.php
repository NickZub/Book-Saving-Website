...
<div class="container-fluid">
    ...
    <div>
        <a href="<?php echo get_url("list_books.php"); ?>" class="btn btn-secondary">Back</a>
        <?php if (has_role("Admin")) : ?>
            <a href="<?php echo get_url("admin/edit_book.php"); ?>?id=<?php se($id,""); ?>" class="btn btn-secondary">Edit</a>
            <a href="<?php echo get_url("admin/delete_book.php"); ?>?id=<?php se($id,""); ?>" class="btn btn-secondary">Delete</a>
        <?php endif; ?>
    </div>
